...
namespace UnsecuredAPIKeys.Data.Migrations
{
    ...
    [Migration("20250709191547_AddDonationSupporterTable")]
    partial class AddDonationSupporterTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UnsecuredAPIKeys.Data.Models.DonationSupporter", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("DonationTrackingId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<bool>("ShowOnSupportersPage")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("DiscordUserId1");

                    b.HasIndex("DonationTrackingId");

                    b.ToTable("DonationSupporters");
                });
            ...
            modelBuilder.Entity("UnsecuredAPIKeys.Data.Models.DonationTracking", b =>
                {
                    ...
                    b.Property<string>("IPNRawMessage")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("UnsecuredAPIKeys.Data.Models.DonationSupporter", b =>
                {
                    b.HasOne("UnsecuredAPIKeys.Data.Models.DiscordUser", "DiscordUser")
                        .WithMany()
                        .HasForeignKey("DiscordUserId1");

                    b.HasOne("UnsecuredAPIKeys.Data.Models.DonationTracking", "DonationTracking")
                        .WithMany()
                        .HasForeignKey("DonationTrackingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DiscordUser");

                    b.Navigation("DonationTracking");
                });
